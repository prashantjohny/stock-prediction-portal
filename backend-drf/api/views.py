...
from .serializers import StockPredictSerializer
...
class StockPredictionAPIView(APIView):
    def post(self, request):
        serializer=StockPredictSerializer(data=request.data)
        if serializer.is_valid():
            ...
            plot_img_path = f'{ticker}_zoom_prediction.png'
            
            zoom_prediction = save_plot(plot_img_path)
            ...
            return Response({'status': 'success','plot_img': plot_img,'plot_100_dma':plot_100_dma,'plot_200_dma':plot_200_dma,'plot_prediction':plot_prediction,'zoom_prediction':zoom_prediction,'mse':mse,'rmse':rmse,'r2':r2,})